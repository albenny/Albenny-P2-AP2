...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Albenny_P2_AP2.Models.Clientes", b =>
                {
            ...
            modelBuilder.Entity("Albenny_P2_AP2.Models.Cobros", b =>
                {
            ...
            modelBuilder.Entity("Albenny_P2_AP2.Models.CobrosDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Albenny_P2_AP2.Models.Ventas", b =>
                {
                    b.Property<int>("VentaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Albenny_P2_AP2.Models.CobrosDetalle", b =>
                {
                    b.HasOne("Albenny_P2_AP2.Models.Cobros", "Cobro")
                        .WithMany("Detalle")
                        .HasForeignKey("CobroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Albenny_P2_AP2.Models.Ventas", "Venta")
                        .WithMany("Detalle")
            ...
            modelBuilder.Entity("Albenny_P2_AP2.Models.Ventas", b =>
                {
                    b.HasOne("Albenny_P2_AP2.Models.Clientes", null)
                        .WithMany("venta")
