...
namespace Albenny_P2_AP2.DAL
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        Microsoft.EntityFrameworkCore.Metadata.Builders.DataBuilder<Ventas> dataBuilder = modelBuilder.Entity<Ventas>().HasData(new Ventas() { VentaId = 2, Fecha = new DateTime(2020, 10, 01), ClienteId = 1, Monto = 900, Balance = 800 });
